// mobileCheck code from Naoto Heida
...
if (isMobile == false) {
    ...
    //.out()
    // 14 December 2020 - Distraction from the bareness of it all
    visFX.solid()
        .add(visFX.shape(3).rotate(Math.PI).scale(() => (0.5 + 1.25), .1, 1).scrollX(0.45).rotate([0, Math.PI * 0.25, Math.PI * 0.75, Math.PI, Math.PI * 1.25, Math.PI * 1.5, Math.PI * 1.75].ease('easeInOutCubic').fast(0.5)))
        .add(visFX.shape(3).scale(() => (0.25 * 2.5 + 1), .1, 1).scrollX(0.25).rotate([0, Math.PI * 0.25, Math.PI * 0.75, Math.PI, Math.PI * 1.25, Math.PI * 1.5, Math.PI * 1.75].ease('easeInOutCubic')))
